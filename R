...
def star():
    ...
    print 47* '\033[1;93m='
    print
    psb('\x1b[1;91m[\x1b[1;92m1\x1b[1;96m]  \x1b[1;93mINDIA CLONING    ')
    print
    psb('\x1b[1;91m[\x1b[1;92m2\x1b[1;96m]  \x1b[1;93mINDIA CLONING    ')
    print
    psb('\x1b[1;91m[\x1b[1;92m3\x1b[1;96m]  \x1b[1;93mINDIA CLONING    ')
    print
    psb('\x1b[1;91m[\x1b[1;92m4\x1b[1;96m]  \x1b[1;93mINDIA CLONING    ')
    print
    psb('\033[1;91m[\x1b[1;93m0\x1b[1;96m] \x1b[1;92mCLOSE')
    print
    print 47* '\033[1;93m='
    star()
...
def star():
    ...
    if star == '':
        ...
        print
        try:
            c = raw_input('TYPE ANY 4 DIGIT NUMBER\n\x1b[1;93mTYPE ANY CODE FROM 9540 TO 9970\n>  ')
            k = '+91'
            idlist = '.txt'
        ...
        print
        try:
            c = raw_input('TYPE ANY 3 DIGIT NUMBER\n\x1b[1;93mTYPE ANY CODE FROM 601 TO 770\n> ')
            k = '+91'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        action()
    print 47* '\033[1;93m='
    star = raw_input('\033[1;96mENTER PASSWORD 1 : ')
    starr = raw_input('\033[1;96mENTER PASSWORD 2 : ')
    starrr = raw_input('\033[1;96mENTER PASSWORD 3 : ')
    print 47* '\033[1;93m='
    xxx = str(len(id))
    psb('[\xe2\x9c\x93] \033[1;91mTOTAL NUMBERS: ' + xxx)
    time.sleep(0.5)
    psb('[\xe2\x9c\x93]\033[1;94m PLEASE WAIT, PROCESS IS START..')
    time.sleep(0.5)
    psb('[!] \033[1;92mTO STOP THIS PROCESS PRESS Ctrl THEN z')
    time.sleep(0.5)
    print 47* '\033[1;93m='
    print
