...
def menu():
    ...
    print 47* '\033[1;97m_'
    print
    psb('\x1b[1;95m[\x1b[1;92m1\x1b[1;94m]  \x1b[1;93mBANGLADESH CLONING')
...
def star():
    ...
    Somi = raw_input('PASSWORD 1 : ')
    SomiI = raw_input('PASSWORD 2 : ')
    ...
    time.sleep(0.5)
    print 47* '\033[1;97m='
    psb('\033[1;93mBHAAR MEIN GAI COLLABS MAIN TOU MASHOOR SA HON')
    psb('UTHAAE BAGHAIR KAMIYAB MAIN MAGHROOR SA HON')
    psb('GUSSA TOU NI AA RHA MERE ALFAAZON SE?')
    psb('AaRA HAI TOU PATLO MERA JAAKE KHUAABON MA')
    print 47* '\033[1;97m='
    print
